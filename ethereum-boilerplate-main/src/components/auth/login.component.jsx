...
const Login = () => {
  ...
  const signInUser = async () => {
    setLoading(true);
    const userData = await fetch(`${baseUrl()}/auth/login-user`, options);
    if (!userData.ok) {
  ...
  return (
    <div className="bg-blue-500 w-screen h-screen flex justify-center items-center">
      <div className="flex flex-col gap-8 bg-white p-10 pt-5 rounded-xl shadow-2xl w-96">
        <h1 className="text-lg text-center font-bold">Login Form for Users</h1>
